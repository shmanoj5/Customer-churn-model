---
title: "QWE"
author: "Team - Nitesh Jindal(11915048), Manoj Sharma(11915050), Deepak Singhania(11915070)"
date: "12/19/2019"
output:
...
# Filter the data as per wall's belief -  
...
#Calculated below the predicted probability that customer 354 will leave between December 2011 and February 2012 is -> 10.02 %
predicted_churn[354]*100
...
#Calculated below the predicted probability that customer 5203 will leave between December 2011 and February 2012 is -> 2.89 %
predicted_churn[5203]*100
...
```{r, better_approach_code_part}


#Creating confusion matrix for our logistic regression approach to check misclassified customers-
